	...
	<xsl:template match="/">
		...
		<div class="block-title">
			<div class="head-title">
				<h1>
					<xsl:value-of disable-output-escaping="yes" select="DealerList/ModuleTitle"></xsl:value-of>
				</h1>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-lg-9">
				<div id="map">
					...
					<div class="map-wrapper">
						<iframe src="" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false"
